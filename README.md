...
[![Try online](https://img.shields.io/badge/try-online-brightgreen)](https://cube-beast.guillaumehaerinck.com/)
...
Supports WASM build so it can be played on any web-browser like Chrome, Firefox or Safari. Just run the content of the `www` folder on a web server or open [this page](https://cube-beast.guillaumehaerinck.com/). A Post-Mortem about the project evolution is available [here](/doc).
